...
local path = ConvertConfig.FolderIn
...
------ 功能实现
------------------------
_sys:command('python fancy-res-helper.py pvr-start', true, false)
...
local function toPvr()
	...
	bsf:write(resizes)
	bsf:close()
	_sys:command('python fancy-res-helper.py pvr-run', true, false)
end
toPvr()
...
_sys:command('python fancy-res-helper.py pvr-done', true, false)
print('============================= DONE =============================')
_abort()