...
class Ui_DetectDuplicateFilesWidget(object):
    def setupUi(self, DetectDuplicateFilesWidget):
        ...
        self.pushButton_build.setGeometry(QRect(730, 20, 100, 50))
        font = QFont()
